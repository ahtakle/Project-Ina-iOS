...
//        for (index, element) in arrayDaily.enumerated() {
//        let myPath = NSIndexPath(item: index, section: 0)
//            if(element) {
//                self.tableView.selectRow(at: myPath as IndexPath, animated: false, scrollPosition: UITableViewScrollPosition.top)
//            }
//        }
